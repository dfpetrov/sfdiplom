    ...
    return function (t) {
        ...
        var r = n(1),
            ...
            c = function (t, e, n) {
                ...
                for (l in p && (n = e), n) f = ((u = !d && v && void 0 !== v[l]) ? v : n)[l], h = m && u ? a(f, r) : g && "function" == typeof f ? a(Function.call, f) : f, v && s(v, l, f, t & c.U), y[l] != f && o(y, l, h), g && w[l] != f && (w[l] = f)
            };
        ...
        t.exports = function (t, e, n, p, _, g, m) {
            ...
            if (D && (w = u(D.call(new t))) !== Object.prototype && w.next && (l(w, T, !0), r || "function" == typeof w[f] || s(w, f, d)), x && C && "values" !== C.name && (S = !0, O = function () {
                    return C.call(this)
                }), r && !m || !h && !S && E[f] || s(E, f, O), a[e] = O, a[T] = d, _)
                if (v = {
                        values: x ? O : b("values"),
                        keys: g ? O : b("keys"),
                        entries: A
                        ...
                        if (h(t, n, o, s, i), 0 !== r && o && (l(o) || c(o))) {
                            ...
                            for (var f = u ? u.length : 0, d = 0; f > d; d++)
                                if ("splice" !== i) m(o, u[d], void 0 === r ? r : r - 1);
                                    ...
                                    for (var p = 0; p < o.length; p++) m(o[p], u[d], void 0 === r ? r : r - 1)
                        }
                    ...
                    t.__watchers__[e].push(n), i && function () {
                        ...
                        void 0 !== n ? function () {
                            ...
                            function (t, e, n, r) {
                                ...
                                var i = t.__proxy__[e];
                                if (0 !== r && t[e] && (l(t[e]) || c(t[e])) && !t[e].__watchers__)
        ...
        n(64)("split", 2, function (t, e, n, u) {
            ...
            return p = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, e) {
                ...
                for (var o, s, a, c = [], u = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), f = 0, d = void 0 === e ? 4294967295 : e >>> 0, p = new RegExp(t.source, u + "g");
                ...
                for (var w = 0, b = 0, T = []; b < h.length;) {
                    v.lastIndex = d ? b : 0;
                    var x, S = c(v, d ? h : h.slice(b));
                    if (null === S || (x = f(a(v.lastIndex + (d ? 0 : b)), h.length)) === w) b = s(h, b, g);
                    else {
        ...
        "function" != typeof this.RetargetMouseScroll && function () {
            ...
            this.RetargetMouseScroll = function (e, n, r, i, o) {
                ...
                return (s = e.addEventListener) ? (s.call(e, t[0], l, !1), s.call(e, t[1], l, !1)) : (s = e.attachEvent) && s.call(e, "on" + t[1], l), (a = e.removeEventListener) ? c = function () {
            ...
            y = function (t) {
                ...
                return e = {
                    ...
                    _handleFixedPositionedScroll: function () {
                        void 0 !== this._fixedPositionedScrollHandler && this._fixedPositionedScrollHandler.restore(), this._isValidScrollTarget() && this._isPositionedFixedEmulated && this.scrollTarget !== this._doc && (this._fixedPositionedScrollHandler = Object(u.RetargetMouseScroll)(this.element, this.scrollTarget))
                    }
                    ...
                    if (0 !== this._height && !this.disabled && (e || t !== this._lastScrollTop)) {
                        var n = 0,
                            ...
                            l = Date.now();
                        if (this._mayMove() && (r = this._clamp(this.reveals ? i + s : t, 0, o)), t >= this._dHeight && (r = this.condenses ? Math.max(this._dHeight, r) : r), this.reveals && a < 100 && ((l - this._initTimestamp > 300 || this._wasScrollingDown !== c) && (this._initScrollTop = t, this._initTimestamp = l), t >= o))
        ...
        i(i.S + i.F * !n(74)(function (t) {
            ...
            from: function (t) {
                var e, n, i, f, h = o(t),
                    ...
                    m = 0,
                    v = u(h);
                if (g && (_ = r(_, p > 2 ? arguments[2] : void 0, 2)), null == v || d == Array && a(v))
                    for (n = new d(e = c(h.length)); e > m; m++) l(n, m, g ? _(h[m], m) : h[m]);
                else
                    for (f = v.call(h), n = new d; !(i = f.next()).done; m++) l(n, m, g ? s(f, _, [i.value, m], !0) : i.value);
                return n.length = m, n
            }
        })
    }, function (t, e, n) {
        ...
        if (!d(" 0o1") || !d("0b1") || d("+0x1")) {
            d = function (t) {
                ...
                return n instanceof d && (g ? c(function () {
                    _.valueOf.call(n)
                }) : "Number" != o(n)) ? s(new p(v(e)), n, d) : v(e)
            };
            for (var y, w = n(2) ? l(p) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), b = 0; w.length > b; b++) i(p, y = w[b]) && !i(d, y) && f(d, y, u(p, y));
